  ...
  return (
    <div style={styles.container}>
      ...
      <header style={styles.header}>
        ...
        <div style={styles.streak}>🔥 {studyStats.streakDays} day streak</div>
      </header>

      <main style={styles.main}>
        {activeTab === 'reader' && (
          <div style={styles.readerContainer}>
            <div style={styles.documentPanel} onMouseUp={handleTextSelect}>
                ...
                <div style={styles.quizOverlay}>
                  <div style={styles.quizCard}>
                    ...
                    {showQuizAnswer ? (
                      ...
                      <button style={styles.revealButton} onClick={() => setShowQuizAnswer(true)}>
                        Reveal Answer
                      </button>
                    )}
                    {showQuizAnswer && (
                    ...
                    <button style={styles.closeQuiz} onClick={() => setQuizActive(false)}>✕</button>
                  </div>
                </div>
              )}
            </div>

            <div style={{...styles.aiPanel, ...(showAIPanel ? styles.aiPanelOpen : {})}}>
              {showAIPanel ? (
                <>
                  <div style={styles.aiHeader}>
                    <span style={styles.aiTitle}>✦ Kapul AI</span>
                    <button style={styles.closeButton} onClick={() => setShowAIPanel(false)}>✕</button>
                  </div>
                  ...
                  <div style={styles.aiActions}>
                    ...
                    <button style={styles.aiActionBtn} onClick={addHighlight}>
                      🖍️ Highlight
                    </button>
                  </div>
                    ...
                    {isLoading ? (
                      ...
                      <>
                        <div style={styles.responseContent}>
                          {aiResponse.split('\n').map((line, i) => (
                            <p key={i} style={styles.responseLine}>{line}</p>
                          ))}
                        </div>
                        <button style={styles.flashcardBtn} onClick={addFlashcard}>
                          + Add to Flashcards
                        </button>
                      </>
                    ) : (
                      <p style={styles.aiPlaceholder}>Choose an action above to get AI assistance.</p>
                    )}
                  </div>
                </>
              ) : (
                <div style={styles.aiCollapsed}>
                  ...
                  <button style={styles.quizButton} onClick={startQuiz}>
        ...
        {activeTab === 'study' && (
          <div style={styles.studyContainer}>
            ...
            <div style={styles.studySection}>
              ...
              <button style={styles.reviewButton}>Start Review Session →</button>
            </div>
          ...
          <div style={styles.libraryContainer}>
            ...
            <div style={styles.bookGrid}>
              {[
                ...
                <div key={i} style={styles.bookCard} onClick={() => setActiveTab('reader')}>
...
const styles = {
  ...
  progressText: { fontSize: '12px', color: '#52525b' },
  documentContent: { lineHeight: 1.8 },
  ...
  aiTitle: { fontSize: '18px', fontWeight: '600', color: '#FBBF24' },
  closeButton: {
    background: 'none',
    border: 'none',
    color: '#71717a',
  ...
  responseContent: { animation: 'fadeIn 0.3s ease' },
  responseLine: {
    fontSize: '14px',
    color: '#d4d4d8',
    marginBottom: '8px',
  ...
  quizProgress: { color: '#FBBF24', fontWeight: '600' },
  quizQuestion: {
    fontSize: '20px',
    fontWeight: '500',
    color: '#fff',
  ...
  studyContainer: { animation: 'fadeIn 0.4s ease' },
  statsGrid: {
    display: 'grid',
  ...
  flashcardFront: { fontSize: '14px', color: '#d4d4d8', lineHeight: 1.5 },
  reviewButton: {
    padding: '12px 24px',
    background: 'linear-gradient(135deg, #3B82F6, #8B5CF6)',
    border: 'none',
  ...
  highlightText: { fontSize: '14px', color: '#a1a1aa', lineHeight: 1.5 },
  libraryContainer: { animation: 'fadeIn 0.4s ease' },
  libraryHeader: {
    display: 'flex',
    justifyContent: 'space-between',
    alignItems: 'center',
  ...
  bookAuthor: { fontSize: '13px', color: '#71717a', marginBottom: '12px' },
  bookProgress: {
    height: '3px',
    background: 'rgba(255,255,255,0.1)',
    borderRadius: '2px',
  ...
  bookProgressText: { fontSize: '11px', color: '#52525b' },
}
